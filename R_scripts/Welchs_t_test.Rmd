...
## Conduct t-tests to compare means between cases and controls for each measurement


t_test_result_waist <- t.test(Adult_Waist_Circumference_Protocol ~ outcome, data = no_person_id)
t_test_result_waist

t_test_result_Body_height <- t.test(Body_height ~ outcome, data = no_person_id)
t_test_result_Body_height

t_test_result_BMI <- t.test(BMI ~ outcome, data = no_person_id)
t_test_result_BMI

t_test_result_Body_weight <- t.test(Body_weight ~ outcome, data = no_person_id)
t_test_result_Body_weight

t_test_result_Diastolic_blood_pressure <- t.test(Diastolic_blood_pressure ~ outcome, data = no_person_id)
t_test_result_Diastolic_blood_pressure

t_test_result_Heart_rate <- t.test(Heart_rate ~ outcome, data = no_person_id)
t_test_result_Heart_rate

t_test_result_hip_circumference <- t.test(hip_circumference ~ outcome, data = no_person_id)
t_test_result_hip_circumference

t_test_result_Systolic_blood_pressure <- t.test(Systolic_blood_pressure ~ outcome, data = no_person_id)
t_test_result_Systolic_blood_pressure
