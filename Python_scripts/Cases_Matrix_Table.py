...
# Define the path to the file containing the cases person_id list
flagged_samples = "gs://fc-secure-e8c07dee-29f2-4c12-a27b-56054fc762ef/cases_person_id.txt"
...
out_path = f'{bucket}/data/test_plink_cases'
